document.addEventListener('DOMContentLoaded', function () {
  ...
  document.body.addEventListener('submit', function (e) {
    ...
    fields.forEach(function (field) {
      ...
      if (field.required && value === '') {
        ...
        } else if (field.minLength && value.length < parseInt(field.minLength, 10)) {
          errorMsg =
            field.dataset.errorMinlength ||
            'Minimum ' + field.minLength + ' characters required.';
        } else if (field.maxLength && parseInt(field.maxLength, 10) > 0 && value.length > parseInt(field.maxLength, 10)) {
          errorMsg =
  ...
  function showFormSuccess(form) {
    showFormMessage(
      form,
      form.dataset.successMessage || 'Thank you! Your message has been sent.',
      'success'
    );
  }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "קלין סטוק משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '9cda3777-5a34-4c33-8381-562211743a8d',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '9cda3777-5a34-4c33-8381-562211743a8d';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '9cda3777-5a34-4c33-8381-562211743a8d';
